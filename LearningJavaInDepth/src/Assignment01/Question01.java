...
public class Question01  {
	...
	public static void main(String[] args) {
		Student obj = new Student("Rini", 14, 'H', 88);
		Student obj1 = new Student("shivali", 14, 'H', 78);
		Student obj2 = new Student("soniya", 12, 'H', 98);
		Student obj3 = new Student("Shreya", 15, 'H', 38);
		Student obj4 = new Student("Niharika", 69, 'H', 58);
		Student obj5 = new Student("Astha", 18, 'H', 98);
		//Getting the result 
