...
public class P15_FileHandling {
	...
	{
		ABC10 obj =new ABC10();
		obj.takeInputFromAFileNotConsole();
...
{
	static int a=10;
	void takeInputFromAFileNotConsole ()
	{
		String path = "C:\\Users\\DELL\\git\\LearningJavaInDepth\\LearningJavaInDepth\\src\\unit_03\\Input.txt";
